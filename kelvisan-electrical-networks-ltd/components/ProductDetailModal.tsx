...
import { Product } from '../app/interfaces/Product'; // Assuming the path is correct
    ...
    >
      ...
      >
        ...
        <button
          ...
          className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg text-sm transition duration-300 transform hover:scale-105 shadow-md mt-4"
        >
          Order via WhatsApp
        </button>
